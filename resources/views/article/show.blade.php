            ...
            <div
                ...
                <div class="col-12 col-lg-5 ms-lg-4 d-flex flex-column justify-content-between cardCart">
                    <div class="d-flex flex-column justify-content-between text-dark">
                        ...
                        <hr class="my-2">
                        <h6 class="fst-italic "><span class="fw-bold"
                                id="cardCategory">#{{ ucfirst(__('ui.' . $article->category->name)) }}</span>
                        </h6>
                        <hr class="my-2">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-start my-4">
                        <h5>
                            </span>{{ ucWords(Auth::user()->name) }}, guarda tutti gli articoli di
                            <span>{{ ucfirst($article->user->name) }}</span>
                        </h5>
                    </div>
                            ...
                            <div class="col-12 col-md-3 m-3">
                                <div class="cardRichiamo sfumatura" style="width: 18rem;">
                                    @if ($userArticle->images->isNotEmpty())
                                        <img src="{{ $userArticle->images->first()->getUrl(1000, 1000) }}"
                                            class="card-img-top" alt="{{ $userArticle->title }}">
                                    @else
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <a href="{{ route('article.show', $userArticle->id) }}"
                                                class="btn btn-primary">{{ __('ui.btnShow') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
