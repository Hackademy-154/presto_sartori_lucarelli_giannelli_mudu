<x-layout>
    <div class="container min-vh-100">
        <div class="row pt-5 justify-content-center">
            ...
            <div class="col-12 p-3 d-flex flex-md-row justify-content-start justify-content-md-center align-items-center my-3 incipit">

                <div class=" row d-flex flex-column flex-md-row justify-content-evenly align-items-center w-100 criteriContainer">

                    <div class="col-4 d-flex flex-column justify-content-center align-items-center align-items-md-start criterio">
