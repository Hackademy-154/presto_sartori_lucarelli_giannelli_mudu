        ...
        <div class="row  py-1">
            <div class="col-12 d-flex align-items-center  w-100">
                ...
                @if ($query)
                    ...
                    <a class="colorPetrolio fw-bold" href="">
                        {{ $category = \App\Models\Category::where('name', $query)->first() ? __('ui.' . $query) : ucfirst($query) }} <span
                            class="mx-0 mx-md-1">></span></a>
                @else
                    <a class="colorPetrolio fw-bold" href="{{ route('article.index') }}"> {{ __('ui.articles') }} <span class="mx-0 mx-md-1">></span></a>
                    <span class="colorPetrolio fw-bold"> {{ __('ui.allArticles') }} </span> <span class="mx-0 mx-md-1">></span></a>
                @endif
